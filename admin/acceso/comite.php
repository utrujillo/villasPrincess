<?php
    ...
    $dir        = '../fileUploader/server/comite/files/';
    $dirPath    = 'fileUploader/server/comite/files/';
    ...
    <tbody class="files">
    	...
    	?>
	    	...
	    	<tr>
	    		...
	    		<td class="txtCenter">
                    <a href="scripts/download.php<?php echo "?f=". $archivo ."&folder=comite"; ?>" class="btn btn-villa" data-original-title="Descargar Archivo" data-placement="left" rel="tooltip" >
